...
- Python (`rcx_pi/selfhost/`) and JavaScript (`substrates/js/eval_step.js`) must remain in parity
...
- Run `node substrates/js/eval_step.js` to verify JS parity after Python changes
