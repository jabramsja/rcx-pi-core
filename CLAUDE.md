...
5. **Keep standards high. Work hard because excellence is where the reward lives.** Don't add headroom to mask performance issues — find and fix root causes. Don't defer issues you can fix now. Don't classify findings as "out of scope" to avoid work. Maintain discipline without self-deprecation — treat feedback as sharpening, not evidence of failure.
