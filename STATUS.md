...
| **Total inventory sites** | 311 | Full named host-runtime surface in scope. Every function in the runtime tree that touches any host-language construct. Per-substrate: 181 Python + 130 JavaScript. | `tools/checks/host_authority_inventory_baseline.json` (total inventory) |
