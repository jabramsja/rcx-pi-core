...
- Tracker sync note (2026-04-11, learning-store-enforcement-2026-04-08): **feat: learning store baseline + recovery_gate hardening.**. Class: L4_ENABLER. target_gate_id: G8. evidence_command: `PYTHONHASHSEED=0 python3 -m pytest -x --tb=short mu/tests/tools/test_recovery_gate.py`. evidence_delta: (1) Routed commit handoff scopes 7 wave-owned file(s). (2) Evidence gate exercises 1 wave-owned test module(s). (3) Indicator artifact binds the wave to reports/l4_wave_indicators/learning-store-enforcement-2026-04-08.json.. progress_proof_before: The routed commit handoff had not yet been bound to a contract-complete tracker note, so downstream L4 governance could fail during pre-push.. progress_proof_after: The routed commit handoff for learning-store-enforcement-2026-04-08 is now bound to 7 wave-owned file(s), 1 wave-owned test module(s), and a canonical indicator artifact.. primary_blocker_class: INTEGRATION. primary_invariant_id: INV_STRUCTURAL_FORWARD_MOTION. indicator_artifact_ref: reports/l4_wave_indicators/learning-store-enforcement-2026-04-08.json. indicator_collection_command: python3 mu/tools/metrics/collect_l4_wave_indicators.py --wave-id learning-store-enforcement-2026-04-08 --output reports/l4_wave_indicators/learning-store-enforcement-2026-04-08.json. bootstrap_endgame_policy: SUBSTRATE_INDEPENDENT_MINIMAL_BOOTSTRAP. boot0_track_id: V1. boot0_progress_state: HOLD. FOUNDER_OVERRIDE:learning-store-enforcement-2026-04-08 (founder authorized L4_ENABLER — control-surface learning-store + recovery_gate hardening; non-structural adjacency cap bypass granted per founder directive 2026-04-10 because the prior wave was L4_ENABLER and a structural wave is not ready to land ahead of this one).
