...
- Tracker sync note (2026-04-12, bot-sweep-fixes-2026-04-12): **fix: remediation staging split for .claude/ paths + adapter bot fixes.**. Class: L4_ENABLER. target_gate_id: G8. evidence_command: `python3 mu/tools/metrics/collect_l4_wave_indicators.py --wave-id bot-sweep-fixes-2026-04-12 --output reports/l4_wave_indicators/bot-sweep-fixes-2026-04-12.json`. evidence_delta: (1) Routed commit handoff scopes 2 wave-owned file(s). (2) No wave-owned pytest module was staged in this ad hoc handoff, so indicator collection is the mechanical evidence surface. (3) Indicator artifact binds the wave to reports/l4_wave_indicators/bot-sweep-fixes-2026-04-12.json.. progress_proof_before: The routed commit handoff had not yet been bound to a contract-complete tracker note, so downstream L4 governance could fail during pre-push.. progress_proof_after: The routed commit handoff for bot-sweep-fixes-2026-04-12 is now bound to 2 wave-owned file(s), 0 wave-owned test module(s), and a canonical indicator artifact.. primary_blocker_class: INTEGRATION. primary_invariant_id: INV_STRUCTURAL_FORWARD_MOTION. indicator_artifact_ref: reports/l4_wave_indicators/bot-sweep-fixes-2026-04-12.json. indicator_collection_command: python3 mu/tools/metrics/collect_l4_wave_indicators.py --wave-id bot-sweep-fixes-2026-04-12 --output reports/l4_wave_indicators/bot-sweep-fixes-2026-04-12.json. bootstrap_endgame_policy: SUBSTRATE_INDEPENDENT_MINIMAL_BOOTSTRAP. boot0_track_id: V1. boot0_progress_state: HOLD.
 FOUNDER_OVERRIDE:bot-sweep-fixes-2026-04-12 (founder authorized L4_ENABLER).
 FOUNDER_OVERRIDE:bot-sweep-fixes-2026-04-12 (founder authorized L4_ENABLER for bot-sweep fixes).
 FOUNDER_OVERRIDE:pipeline-final-fixes-2026-04-12 (founder authorized L4_ENABLER).
 FOUNDER_OVERRIDE:pipeline-final-fixes-2026-04-12 (founder authorized L4_ENABLER for final pipeline fixes).
 FOUNDER_OVERRIDE:pipeline-followup-fixes-2026-04-12 (founder authorized L4_ENABLER).
 FOUNDER_OVERRIDE:pipeline-followup-fixes-2026-04-12 (founder authorized L4_ENABLER for 7 pipeline followup fixes from PRs #757-761 bot findings).
 FOUNDER_OVERRIDE:main-repo-dirty-merge-2026-04-12 (founder authorized L4_ENABLER).
 FOUNDER_OVERRIDE:main-repo-dirty-merge-2026-04-12 (founder authorized L4_ENABLER for accumulated config/hook/skill changes — preflight 8-min cron is a tooling enabler).
 FOUNDER_OVERRIDE:bot-findings-auto-defer-2026-04-12 (founder authorized L4_ENABLER — CI poll fallback + recovery classifier for bot findings).
 FOUNDER_OVERRIDE:bot-findings-auto-defer-2026-04-12 (founder authorized L4_ENABLER — auto-defer + recovery wiring for bot findings per founder directive; non-structural adjacency bypass required).
 FOUNDER_OVERRIDE:disable-sdk-agent-review-2026-04-12 (founder authorized L4_ENABLER — SDK agent review disabled via config flag per founder directive; bridge + bot review remain as convergence gates).
 FOUNDER_OVERRIDE:post-merge-verify-fetch-fix-2026-04-11 (founder authorized L4_ENABLER for phase_b_executor bot-finding remediation — addresses PR #757 P1 findings on agent review infrastructure failure handling).
 FOUNDER_OVERRIDE:post-merge-verify-fetch-fix-2026-04-11 (founder authorized L4_ENABLER for phase_b_executor infrastructure fixes — agent-review-as-warning + staging split are prerequisite for all future pipeline waves; non-structural adjacency bypass required as prior waves were all L4_ENABLER pipeline hardening).
...
- **[PIPELINE-RECOVERY]** **IN PROGRESS** (2026-03-31, founder-authorized).
  ...
  **File:** `mu/tools/executors/recovery_gate.py`
  ...
  ~~**Phase 5:** Learning store~~ **Landed** (PR #751, code baseline — 748 tests, 1800 LOC). Integration gaps remain: no `.claude/rules/learning.md` cross-pollination, no subagent warming.
