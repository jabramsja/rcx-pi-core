...
Tracker sync note (2026-02-17, doc-drift-sync-deprecation): Comment-only changes — added DEPRECATED annotations to rcx_cli.py (archived program subcommand), worlds_probe.py, world_trace_cli.py, worlds/__init__.py (Rust bridge paths). Removed dead _rcx_dispatch function. Deleted 5 orphaned .pyc files. No behavior/phase/debt change.
