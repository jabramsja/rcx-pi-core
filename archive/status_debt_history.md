...
## Current Marker Breakdown (12 = 6 Py decorator + 6 JS decorator)
...
Per-category decorators: Py = 2 recursion + 1 builtin + 3 iteration + 0 mutation; JS = 2 recursion + 2 builtin + 2 iteration.
