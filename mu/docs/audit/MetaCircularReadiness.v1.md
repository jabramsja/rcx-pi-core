...
**Note on v2 Observability**: Stall/fix events are now OBSERVABLE via v2 trace events (`reduction.stall`, `reduction.applied`, `reduction.normal`) gated by `RCX_TRACE_V2=1`. Execution semantics (v0) are implemented and gated by `RCX_EXECUTION_V0=1`. See `mu/docs/execution/StallFixObservability.v0.md`.
...
5. ✅ **Execution engine with stall/fix events** — `mu/docs/execution/StallFixExecution.v0.md`
...
- Bootstrap primitives: see `mu/docs/core/BootstrapPrimitives.v0.md` for canonical list
...
- `mu/docs/core/MetaCircularKernel.v0.md` (Phase 7 design, VECTOR)
- `mu/docs/core/StructuralPurity.v0.md` (guardrails)
- `EntropyBudget.md`
