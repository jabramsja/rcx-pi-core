...
- `mu/docs/core/BootstrapPrimitives.v0.md` - Current primitive documentation (Boot0 formalizes this)
- `mu/docs/core/MetaCircularKernel.v0.md` - Kernel state machine spec (Boot2)
- `mu/docs/core/EngineNewsStructural.v0.md` - Closure detection spec (Boot2)
