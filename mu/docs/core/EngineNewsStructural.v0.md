...
**Note:** This spec covers `recurrence.v1.json` (proof-of-concept, 9 projections). For production use, see `recurrence.v2.json` (hash-accelerated, same 9 projections with SHA-256 boundary hashing). Design: `mu/docs/core/recurrence_v2_design.md`.
...
- `mu/docs/core/BootstrapPrimitives.v0.md` - What Python can do
- `mu/docs/core/MetaCircularKernel.v0.md` - How kernel executes projections
