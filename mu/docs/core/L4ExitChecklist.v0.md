...
|-----------|-------------------------------|
| `eval_step` | D005 pilot already in production (PR #452). Stage 0 is default ON (`_STAGE0_PILOT=True` in both Python and JS, 2026-03-09). JS Stage 0 parity confirmed (90 gate tests). Further reduction requires: performance profiling under production workloads, CPS feasibility assessment (see G8CpsFeasibility.v0.md). |
