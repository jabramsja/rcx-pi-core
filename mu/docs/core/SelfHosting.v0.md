...
- `mu/docs/core/EVAL_SEED.v0.md` - Current EVAL_SEED spec
- `mu/docs/execution/DeepStep.v0.md` - Deep traversal design
...
- `mu/` - Mu projection definitions:
  ...
  - `closures/exhaustion.v1.json` - Operator exhaustion (13 projections)
