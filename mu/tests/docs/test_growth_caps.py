...
CAP_TOOL_SCRIPTS = 12  # 2 runners + 3 checks + 1 host-authority inventory ratchet + 1 merge_pr.sh hook + 1 lower_stage0.py compiler + 1 json_to_dag.py compiler + 1 founder_session_heartbeat.sh + 1 check_stale_next_items.sh + 1 check_js_debt.sh (compat shim)
