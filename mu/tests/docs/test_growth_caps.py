...
CAP_TEST_FILES = 114  # +1 for test_executor_config_alignment.py; +1 for test_codex_startup_state.py (startup hardening, founder sign-off 2026-04-15); +1 for test_pipeline_agent_pager.py (pager wave, founder sign-off 2026-04-17); +1 for test_commit_executor_post_merge_cleanup.py (post-merge-cleanup wave, founder sign-off 2026-04-17); +1 for test_check_private_attr_access.py (AST-anti-cheat wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_commit_executor_step14_conflict_precheck.py (Step 14 conflict fast-fail wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_commit_executor_step14_autoresolve.py (Step 14 auto-resolve wave, standing pipeline-bug-fix authorization 2026-04-20)
CAP_TOOL_SCRIPTS = 42  # +1 for _resolve_live_root.sh; +2 for startup-hardening session tools (founder_learning_snapshot.py, check_codex_startup_state.py; founder sign-off 2026-04-15); +1 for pipeline_agent_pager.py (pager wave, founder sign-off 2026-04-17); +1 for check_private_attr_access.py (AST-anti-cheat wave, standing pipeline-bug-fix authorization 2026-04-20)
