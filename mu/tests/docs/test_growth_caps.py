...
CAP_TEST_FILES = 119  # +1 for test_executor_config_alignment.py; +1 for test_codex_startup_state.py (startup hardening, founder sign-off 2026-04-15); +1 for test_pipeline_agent_pager.py (pager wave, founder sign-off 2026-04-17); +1 for test_commit_executor_post_merge_cleanup.py (post-merge-cleanup wave, founder sign-off 2026-04-17); +1 for test_check_private_attr_access.py (AST-anti-cheat wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_commit_executor_step14_conflict_precheck.py (Step 14 conflict fast-fail wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_commit_executor_step14_autoresolve.py (Step 14 auto-resolve wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_wave_id_derivation.py (restart-branch pre-push derivation wave, founder sign-off 2026-04-21); +1 for test_codex_autoping_watch.py (post-reentry reroute pager/autoping wave, founder sign-off 2026-04-25); +1 for test_phase_a_executor.py (pager lifecycle event coverage wave, founder sign-off 2026-04-26); +1 for test_agent_bus_namespacing.py (parallel pipeline bus namespacing wave, founder sign-off 2026-04-30); +1 for test_pane_prci_observability.py (deferred consolidation E5/E6 wave, FOUNDER_OVERRIDE:deferred-consolidation-e5-e6-2026-04-02)
CAP_TOOL_SCRIPTS = 47  # +1 for _resolve_live_root.sh; +2 for startup-hardening session tools (founder_learning_snapshot.py, check_codex_startup_state.py; founder sign-off 2026-04-15); +1 for pipeline_agent_pager.py (pager wave, founder sign-off 2026-04-17); +1 for check_private_attr_access.py (AST-anti-cheat wave, standing pipeline-bug-fix authorization 2026-04-20); +4 for Codex autoping session watcher scripts (codex_autoping_watch.py, codex_autoping_window.sh, ensure_codex_autoping.sh, render_codex_autoping_status.py; founder sign-off 2026-04-25); +1 for pipeline_monitor_identity.py (parallel pipeline monitor identity wave, founder sign-off 2026-04-30)
