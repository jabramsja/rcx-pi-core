...
CAP_TEST_FILES = 84  # 40 core + 30 fuzzer + 5 deep-scan headroom + 5 P7 gates + 1 GPT findings gate + 1 JS security parity gate + 1 wave5 cleanup gate + 1 wave8 docstring accuracy gate (waves A-K + P7w3-w5 + wave4-core + wave1-js-security + wave5-cleanup + wave8-deferred, 2026-03-12)
