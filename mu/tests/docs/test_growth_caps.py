...
CAP_TEST_FILES = 112  # +1 for test_executor_config_alignment.py; +1 for test_codex_startup_state.py (startup hardening, founder sign-off 2026-04-15); +1 for test_pipeline_agent_pager.py (pager wave, founder sign-off 2026-04-17); +1 for test_commit_executor_post_merge_cleanup.py (post-merge-cleanup wave, founder sign-off 2026-04-17); +1 for test_check_private_attr_access.py (AST-anti-cheat wave, standing pipeline-bug-fix authorization 2026-04-20)
