...
CAP_TEST_FILES = 123  # +1 for test_executor_config_alignment.py; +1 for test_codex_startup_state.py (startup hardening, founder sign-off 2026-04-15); +1 for test_pipeline_agent_pager.py (pager wave, founder sign-off 2026-04-17); +1 for test_commit_executor_post_merge_cleanup.py (post-merge-cleanup wave, founder sign-off 2026-04-17); +1 for test_check_private_attr_access.py (AST-anti-cheat wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_commit_executor_step14_conflict_precheck.py (Step 14 conflict fast-fail wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_commit_executor_step14_autoresolve.py (Step 14 auto-resolve wave, standing pipeline-bug-fix authorization 2026-04-20); +1 for test_wave_id_derivation.py (restart-branch pre-push derivation wave, founder sign-off 2026-04-21); +1 for test_codex_autoping_watch.py (post-reentry reroute pager/autoping wave, founder sign-off 2026-04-25); +1 for test_phase_a_executor.py (pager lifecycle event coverage wave, founder sign-off 2026-04-26); +1 for test_agent_bus_namespacing.py (parallel pipeline bus namespacing wave, founder sign-off 2026-04-30); +1 for test_pane_prci_observability.py (deferred consolidation E5/E6 wave, FOUNDER_OVERRIDE:deferred-consolidation-e5-e6-2026-04-02); +3 for post-redteam engine-state/scheduler structural tests (post-redteam-engine-state-scheduler-reduction-2026-04-30); +1 for test_commit_outcome_pager_lifetime.py (commit-outcome pager worktree-lifetime regression wave, FOUNDER_OVERRIDE:commit-outcome-pager-fix-2026-05-29)
