...
CAP_TEST_FILES = 94  # 40 core + 30 fuzzer + 5 deep-scan headroom + 5 P7 gates + 1 GPT findings gate + 1 JS security parity gate + 1 wave5 cleanup gate + 1 wave8 docstring accuracy gate + 1 wave9 stage0 flag removal gate + 1 wave11 hardening gate + 1 host-authority inventory ratchet test + 1 Wave3B subst VM unification gate + 1 Wave3C match VM staged dispatch gate + 1 Wave3D-A bounded VM helper gate + 1 Wave3D-B classify VM unification gate + 1 Wave4A engine transition gate + 1 Wave5A step monotonicity gate + 1 W6A trusted path gate (2026-03-19). Wave15: freed 12 slots.
