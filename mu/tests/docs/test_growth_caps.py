...
CAP_TEST_FILES = 89  # 40 core + 30 fuzzer + 5 deep-scan headroom + 5 P7 gates + 1 GPT findings gate + 1 JS security parity gate + 1 wave5 cleanup gate + 1 wave8 docstring accuracy gate + 1 wave9 stage0 flag removal gate + 1 wave11 hardening gate + 1 host-authority inventory ratchet test + 1 Wave3B subst VM unification gate + 1 Wave3C match VM staged dispatch gate (waves A-K + P7w3-w5 + wave4-core + wave1-js-security + wave5-cleanup + wave8-deferred + wave9-js-hardening + wave11-hardening + wave13-compat-shims + wave3b-subst-vm + wave3c-match-vm, 2026-03-17). Wave15: freed 12 slots.
