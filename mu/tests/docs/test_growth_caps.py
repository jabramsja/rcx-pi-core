...
CAP_CORE_DOCS = 16  # +1 for L3SubstrateArchitecture.v0.md (extracted from STATUS.md); +1 for StructuralNumbers.v0.md (numbers-as-structural-Mu design spec, FOUNDER_OVERRIDE:structural-numbers-design-doc-2026-06-17); +1 for SurrealNumbers.v0.md (Surreals-as-structure foundation contract, FOUNDER_OVERRIDE:surreals-as-structure-2026-06-26); +1 for RecursiveOrdinals.v0.md (recursive-ordinals foundation contract, FOUNDER_OVERRIDE:recursive-ordinals-as-structure-2026-06-26); +1 for WTypesInductiveTypes.v0.md (W-types / inductive AST foundation contract, FOUNDER_OVERRIDE:w-types-inductive-types-ast-as-inductive-structure-2026-06-26)
