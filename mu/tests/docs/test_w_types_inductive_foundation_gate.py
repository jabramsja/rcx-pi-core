"""Compatibility entry point for the WTypesInductiveTypes foundation gate.
...
from tests.l4_gates.test_w_types_inductive_foundation_gate import *  # noqa: F401,F403
