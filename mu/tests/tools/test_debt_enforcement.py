...
def test_audit_semantic_purity_threshold_matches_status_md():
    ...
    Current threshold: 11 (tracked @host_* marker count - bootstrap substrate lower bound)
...
def test_infra_count_within_ceiling():
    ...
    assert infra_count == 125, (
        f"Expected 125 AST_OK:infra markers, found {infra_count}. "
        f"If this is intentional, update the test."
    )
