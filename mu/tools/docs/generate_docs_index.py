...
Usage:
    python3 mu/tools/docs/generate_docs_index.py
    python3 mu/tools/docs/generate_docs_index.py --check  # Verify index is up-to-date
"""
...
def generate_index(docs_dir: Path) -> str:
    ...
    lines.append("---")
    lines.append("")
    lines.append("*To add a new doc: create the file, then run `python3 mu/tools/docs/generate_docs_index.py`*")
    lines.append("")
    ...
    if args.check:
        ...
        if readme_path.exists():
            ...
            if current_content.strip() == new_content.strip():
                ...
                print("Run: python3 mu/tools/docs/generate_docs_index.py")
                sys.exit(1)
        else:
