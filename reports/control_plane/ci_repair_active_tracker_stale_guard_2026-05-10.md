...
- Add slashed active task label detection such as
  `[CI-REPAIR/<wave-id>]`, resolve `jabramsja/<wave-id>` against merged PRs
  with `gh pr list --state merged --head`, and fail closed when a merged branch
  remains active.
...
- Tracker note sha256: `b3deba0f75586e262517567aa4f980d6cb053195aeea0fbee647fc2286e13b88`
