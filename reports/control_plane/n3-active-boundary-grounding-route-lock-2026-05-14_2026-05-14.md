...
1. Re-ground N3 active status from current tracker and deferred-lane evidence.
   `TASKS.md:563`, `TASKS.md:574`, and `TASKS.md:578` keep N3 broad
...
2. Remove closed candidates from pending work. Stage0 capture-path provenance
   is not reopened because `TASKS.md:562` records the implementation and
   `TASKS.md:563` records the deferred cleanup that archived the generated
   predecessor residue. N5 JS pipeline governance is not reopened because
   `TASKS.md:578` records that N5 live wording was removed from active deferred
...
- **Engine pipeline thin-core/module extraction.** Prior N5 JS pipeline
  governance cleanup is closed by `TASKS.md:578`. `L4MicroAbi.v0.md:141`
...
- **Stage0 trusted/public export follow-ons.** Stage0 capture-path provenance
  is implemented and cleaned up in `TASKS.md:562` and `TASKS.md:563`. The PR
...
- `TASKS.md:562` records the Stage0 capture-path provenance implementation.
- `TASKS.md:563` records the Stage0 capture provenance deferred cleanup,
  archives closed Stage0 capture residue, and preserves N3 broad host-surface
  boundary as live.
- `TASKS.md:574` records the later Stage0 cleanup DOC_ACCURACY closeout and
  still retains N3 broad host-surface boundary in the active deferred inventory.
- `TASKS.md:578` records post-JS-pipeline governance cleanup, closes live N5
