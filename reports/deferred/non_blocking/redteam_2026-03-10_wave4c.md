...
### D2: 2 unmarked isinstance in projection_runner.py nested closures (Verifier + Structural-Proof) — **RESOLVED 2026-03-15**
- Fixed: Both isinstance calls already annotated with `# AST_OK: infra` (found during MT2 sweep — these were marked in a prior wave but the deferred report was not updated).
