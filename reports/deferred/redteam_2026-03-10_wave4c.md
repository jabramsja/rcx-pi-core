...
### D1: 5 unmarked isinstance calls in classify_mu.py (Structural-Proof + Grounding)
...
### D8: Stale "Phase 7d will eliminate" comment (Structural-Proof)
...
- No compile-time enforcement; adding a seed requires manual 3-way sync
- Design decision, not a bug

### D10: classify_linked_list silent return at 10001-node boundary (Fuzzer)
