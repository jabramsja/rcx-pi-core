...
@pytest.mark.parametrize(
    ...
    [
        "",  # empty
        "\n",  # empty newline
        " tag.v1 docs/a.md mu/docs/schemas/a.json",  # leading space
        "tag.v1 docs/a.md mu/docs/schemas/a.json ",  # trailing space
        "tag.v1  docs/a.md mu/docs/schemas/a.json",  # double space
        "tag.v1\tdocs/a.md mu/docs/schemas/a.json",  # tab
        "tag.v1 docs/a.md mu/docs/schemas/a.json\n\n",  # extra newline
        "tag.v1 docs/a.md",  # too few fields
        "tag.v1 docs/a.md mu/docs/schemas/a.json EXTRA",  # too many fields
        "tag.v1 docs/a.md mu/docs/schemas/a.json\nEXTRA",  # extra non-empty line
        "tag.v1 docs/a.md mu/docs/schemas/a.json\r\n",  # CRLF (should be rejected by token rules)
        "tag.v1 docs/a md mu/docs/schemas/a.json",  # whitespace inside token
        "tag.v1 docs/a.md mu/docs/schemas/a json",  # whitespace inside token
    ],
)
