...
DEBT_THRESHOLD=15  # <-- RATCHET: Lower this as debt is paid, never raise it
# History: 14→23 (PR #155 comprehensive marking), 23→21 (Phase 6a), 21→19 (Phase 6b), 19→15 (Phase 6c)
